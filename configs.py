...
class Config(object):
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001248525327")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "PyMdiskbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5647807185"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "PY_OVNER")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "pymovies7")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001248525327")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Yog:Bot@cluster0.96yztzl.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001641611230"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "pymovies7")
    FORCE_SUB = os.getenv("FORCE_SUB", "True")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "lvxHKpB70yVcUyO3PrkB")
